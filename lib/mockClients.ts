...
export type ScoreHistoryEntry = { scoreDate: string; score: number };
// Alerte avec statut
export type Alert = {
  alertDate: string;
  message: string;
...
export function generateMockClients(count = 1500): ClientMock[] {
  return Array.from({ length: count }, () => {
    ...
    const scoringDetails: ScoringDetail[] = [
      ...
      {
        label: "Lien avec joueur risqué",
        value: faker.number.int({ min: 0, max: 20 }),
      },
      {
        label: "Justif incohérent",
        value: faker.number.int({ min: 0, max: 20 }),
      },
      {
        label: "Retraits suspects",
        value: faker.number.int({ min: 0, max: 20 }),
      },
    ...
    const riskScore = Math.max(
      ...
      Math.min(
        100,
        scoringDetails.reduce((sum, c) => sum + c.value, 0)
      )
    );
    ...
    const behavioralDetails: BehaviorDetail[] = [
      {
        label: "Multiples CB sur compte joueur",
        value: faker.number.int({ min: 0, max: 5 }),
      },
      {
        label: "Cumul de versements CB",
        value: faker.number.int({ min: 0, max: 20000 }),
      },
      {
        label: "Dépôts CB hors pays à risque modéré",
        value: faker.number.int({ min: 0, max: 5000 }),
      },
      {
        label: "Dépôts CB pays à risque élevé",
        value: faker.number.int({ min: 0, max: 3000 }),
      },
      {
        label: "Carte CB utilisée sur multi-comptes",
        value: faker.number.int({ min: 0, max: 3 }),
      },
      {
        label: "IBAN multi-comptes",
        value: faker.number.int({ min: 0, max: 3 }),
      },
      {
        label: "Transactions IBAN vers pays modérés",
        value: faker.number.int({ min: 0, max: 10 }),
      },
      {
        label: "Transactions IBAN vers pays élevés (GAFI)",
        value: faker.number.int({ min: 0, max: 10 }),
      },
      {
        label: "IBAN sur types de banques non-autorisées",
        value: faker.number.int({ min: 0, max: 3 }),
      },
      {
        label: "Nombre de comptes PayPal",
        value: faker.number.int({ min: 0, max: 5 }),
      },
      {
        label: "Volume PayPal sur 6 mois glissants",
        value: faker.number.int({ min: 0, max: 20000 }),
      },
      {
        label: "Multi-titulaire ou multi-comptes PayPal",
        value: faker.number.int({ min: 0, max: 3 }),
      },
      {
        label: "Cumul montant Paysafecard sur 6 mois",
        value: faker.number.int({ min: 0, max: 2000 }),
      },
      {
        label: "Nombre de comptes Paysafecard",
        value: faker.number.int({ min: 0, max: 5 }),
      },
      {
        label: "Dépôts sur solde positif",
        value: faker.number.int({ min: 0, max: 1000 }),
      },
      {
        label: "Cumul des versements rejetés",
        value: faker.number.int({ min: 0, max: 10000 }),
      },
      {
        label: "Nombre de demandes de retrait",
        value: faker.number.int({ min: 0, max: 20 }),
      },
      {
        label: "Retraits avec clôture de compte",
        value: faker.number.int({ min: 0, max: 5 }),
      },
      {
        label: "Demandes de retrait rejetées",
        value: faker.number.int({ min: 0, max: 20 }),
      },
      {
        label: "Retraits exceptionnels (>4/an)",
        value: faker.number.int({ min: 0, max: 10 }),
      },
      {
        label: "Montant du solde non-retirable",
        value: faker.number.int({ min: 0, max: 1000 }),
      },
      {
        label: "Cumul des répudiations",
        value: faker.number.int({ min: 0, max: 500 }),
      },
      {
        label: "Nombre de répudiations",
        value: faker.number.int({ min: 0, max: 10 }),
      },
      {
        label: "Dépassement seuil ODF (>=3/12 mois)",
        value: faker.number.int({ min: 0, max: 5 }),
      },
      {
        label: "Taux de réussite hasard (TRH)",
        value: faker.number.int({ min: 0, max: 200 }),
      },
      {
        label: "Taux de retour joueur hasard (TRJ)",
        value: faker.number.int({ min: 0, max: 200 }),
      },
      {
        label: "Changement coord. identitaires (>3 champs)",
        value: faker.number.int({ min: 0, max: 5 }),
      },
      {
        label: "Connexions régulières depuis IP à l’étranger",
        value: faker.number.int({ min: 0, max: 10 }),
      },
    ];
    ...
    const scoreHistory: ScoreHistoryEntry[] = Array.from(
      { length: 10 },
      (_, i) => ({
        scoreDate: new Date(now.getTime() - i * 86400000)
          .toISOString()
          .slice(0, 10),
    ...
    const alerts: Alert[] = Array.from(
      ...
      () => ({
        alertDate: faker.date.recent({ days: 30 }).toISOString().slice(0, 10),
